package alexclin.xmpp.androidclient.ui.chat;
...
import alexclin.xmpp.androidclient.service.IXMPPChatService;
...
public class ChatActivity extends SherlockListActivity implements OnKeyListener,
		TextWatcher {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mChatFontSize = Integer.valueOf(Application.getConfig(this).chatFontSize);
	...
	class ChatWindowAdapter extends SimpleCursorAdapter {
		...
		ChatWindowAdapter(Cursor cursor, String[] from, int[] to,
			...
			super(ChatActivity.this, android.R.layout.simple_list_item_1, cursor,
					from, to);
