...
import alexclin.xmpp.androidclient.dialogs.GroupNameView;
...
import alexclin.xmpp.androidclient.provider.RosterProvider.RosterConstants;
import alexclin.xmpp.androidclient.service.XMPPService;
import alexclin.xmpp.androidclient.ui.preferences.MainPrefs;
import alexclin.xmpp.androidclient.util.ConnectionState;
import alexclin.xmpp.androidclient.util.PreferenceConstants;
import alexclin.xmpp.androidclient.util.SimpleCursorTreeAdapter;
...
import alexclin.xmpp.androidclient.IXMPPRosterCallback.Stub;
 ...
 *
 */
public class FriendsActivity extends SherlockExpandableListActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mConfig = Application.getConfig(this);
	...
	protected void onResume() {
		...
		if (theme.equals(mTheme) == false) {
			// restart
			Intent restartIntent = new Intent(this, FriendsActivity.class);
	...
	private void startChatActivity(String user, String userName, String message) {
		Intent chatIntent = new Intent(this,
				alexclin.xmpp.androidclient.ui.chat.ChatActivity.class);
		Uri userNameUri = Uri.parse(user);
		chatIntent.setData(userNameUri);
		chatIntent.putExtra(alexclin.xmpp.androidclient.ui.chat.ChatActivity.INTENT_EXTRA_USERNAME, userName);
		if (message != null) {
			chatIntent.putExtra(alexclin.xmpp.androidclient.ui.chat.ChatActivity.INTENT_EXTRA_MESSAGE, message);
		}
	...
	private void showFirstStartUpDialogIfPrefsEmpty() {
		...
		if (configuredJabberID.length() < 3) {
			...
			PreferenceManager.setDefaultValues(this, R.layout.act_mainprefs, false);
			PreferenceManager.setDefaultValues(this, R.layout.act_accountprefs, false);
