 ...
 * Original file: /media/D/WorkSpace/linuxworkspace/Aim/MyAim/src/alexclin/xmpp/androidclient/service/IXMPPChatService.aidl
 */
package alexclin.xmpp.androidclient.service;
public interface IXMPPChatService extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements alexclin.xmpp.androidclient.service.IXMPPChatService
{
private static final java.lang.String DESCRIPTOR = "alexclin.xmpp.androidclient.service.IXMPPChatService";
...
/**
 * Cast an IBinder object into an alexclin.xmpp.androidclient.service.IXMPPChatService interface,
 * generating a proxy if needed.
 */
public static alexclin.xmpp.androidclient.service.IXMPPChatService asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof alexclin.xmpp.androidclient.service.IXMPPChatService))) {
return ((alexclin.xmpp.androidclient.service.IXMPPChatService)iin);
}
return new alexclin.xmpp.androidclient.service.IXMPPChatService.Stub.Proxy(obj);
}
...
private static class Proxy implements alexclin.xmpp.androidclient.service.IXMPPChatService
{
